                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex justify-between md:w-[20%] md:block">
                          ...
                          <span className="text-[14px] text-[#737373]">
                            {formatCard(order.card_last_four)}
                          </span>
                        </div>
                                  ...
                                  >
                                    ...
                                    {product.image ? (
                                      <img
                                        src={product.image}
                                        alt={product.name}
                                        className="h-[80px] w-[80px] shrink-0 rounded-[6px] object-cover"
                                      />
                                    ) : (
                                      <div className="flex h-[80px] w-[80px] shrink-0 items-center justify-center rounded-[6px] bg-[#F5F5F5]">
                                        <PackageCheck
                                          size={28}
