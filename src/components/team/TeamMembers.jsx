...
function TeamMembers({ showTrial = true }) {
  return (
    <div>
      <section className="bg-white py-[60px] md:py-[112px]">
        <div className="mx-auto max-w-[1050px] px-[45px] md:px-0">
          <div className="mb-[45px] text-center md:mb-[80px]">
            <h2 className="text-[40px] font-bold leading-[50px] text-[#252B42]">
              Meet Our Team
            </h2>

            {showTrial && (
              <p className="mx-auto mt-[10px] w-[305px] items-center text-[14px] leading-[20px] text-[#737373]">
      ...
      {!showTrial && (
        <section className="bg-white py-[60px] md:py-[80px]">
          <div className="mx-auto flex max-w-[1050px] flex-col items-center px-[45px] text-center md:px-0">
            ...
            <div className="mt-[30px] flex gap-[34px] text-[30px] md:gap-[30px] md:text-[24px]">
              <FaTwitter className="text-[#23A6F0]" />
